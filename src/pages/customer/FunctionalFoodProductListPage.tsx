...
const FunctionalFoodProductListPage = () => {
    ...
    <div className="bg-white text-gray-800">
      <BreadcrumbTo
        items={[
          ...
          { label: "Thực phẩm chức năng", path: "/functional-foods" },
        ]}
      />
...
export default FunctionalFoodProductListPage;
